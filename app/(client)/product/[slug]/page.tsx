    ...
    <Container className='flex flex-col md:flex-row gap-10 py-10'>
        ...
        <div className='w-full md:w-1/2 flex flex-col gap-5'>
            <div className='space-y-1'>
                ...
                <PriceView price={product?.price} discount={product?.discount} className='mt-2 text-xl'/>
                </div>
                <p className={cn("px-4 py-1.5 font-semibold rounded-lg  inline-block text-center text-sm", product?.stock === 0 ? "bg-red-100 text-red-600": "text-green-600 bg-green-100")}>{(product?.stock as number) > 0? "In Stock" : "Out of Stock"}</p>
            </div>
            ...
            <div className='border border-black/25 p-3 flex items-center gap-2.5'>
                ...
                <p className="text-base font-semibold text-black">Return Policy</p>
