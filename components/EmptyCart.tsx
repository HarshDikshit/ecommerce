  ...
  return (
    <div className='py-10 md:py-20 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4'>
        ...
        className='bg-white rounded-2xl shadow-xl p-8 max-w-md w-full space-y-8'>
            ...
            <div>
                <Link href='/' className='block bg-black/5 border border-black/20 text-center py-2.5 rounded-full text-sm font-semibold tracking-wide hover:border-black hover:bg-black hover:text-white hoverEffect'>
                Discover Products
                </Link>
            </div>
